    ...
    <header className="header">
      <div className="header-container">
        ...
        <nav className="nav-menu">
          ...
          <Link to="/schedule" className="nav-link">Lịch chiếu</Link>
          <Link to="/movies" className="nav-link">Đặt vé</Link>
          <Link to="/about" className="nav-link">Về chúng tôi</Link>
          <Link to="/services" className="nav-link">Dịch vụ & Tiện ích</Link>
        </nav>
                ...
                <div className="user-dropdown">
                  <div className="user-info">
                    ...
                    <div className="user-details">
                      ...
                      <p className="dropdown-email">{user?.email || 'Thành viên Cinebook'}</p>
                    </div>
                  </div>
